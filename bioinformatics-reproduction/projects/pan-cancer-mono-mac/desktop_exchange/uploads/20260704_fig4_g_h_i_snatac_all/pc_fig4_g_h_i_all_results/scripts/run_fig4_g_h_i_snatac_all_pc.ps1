...
& "H:\R\bin\Rscript.exe" "desktop_exchange\requests\20260704_fig4_g_h_i_snatac_all\scripts\run_fig4_gse306459_snatac_fast_merge_all_pc.R" *>&1 |
  Tee-Object -FilePath $logPath
$runExitCode = $LASTEXITCODE

if ($runExitCode -eq 0) {
  & "H:\R\bin\Rscript.exe" "desktop_exchange\requests\20260704_fig4_g_h_i_snatac_all\scripts\postrun_check_fig4_g_h_i_all_pc.R" *>&1 |
