...
$requestPath = 'bioinformatics-reproduction/projects/pan-gi-ici-ccc-20260709/desktop_exchange/20260717_gse205506_paper_qc_rebuild_request.md'
$remoteBase = 'bioinformatics-reproduction/projects/pan-gi-ici-ccc-20260709/desktop_exchange/uploads/20260717_gse205506_paper_qc_rebuild'
...
try {
    ...
    $commitBody = @{
        message = 'Complete GSE205506 source-paper QC rebuild'
        tree = $tree.sha
